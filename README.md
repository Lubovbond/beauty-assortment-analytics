# Анализ эффективности ассортиментной матрицы бьюти-товаров и контроль KPI выкупа 💄 Tableau + Pandas
...
* **Визуализация (BI):** `Tableau` (интерактивная отчетность и факторный анализ)
